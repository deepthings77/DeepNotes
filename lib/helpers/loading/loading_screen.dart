...
import 'package:deepnotes/helpers/loading/loading_screen_controller.dart';
  ...
  void show({
    ...
    required String text,
      ...
      if(controller?.update(text) ?? false){
        ...
        controller = showOvelay(context: context, text: text);
      }
  }
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  children: [
                    ...
                    StreamBuilder( stream: _text.stream  ,builder: (context, snapshot){
